        ...
        $state.transitionTo = function (to, toParams, options) {
          ...
          if (toStateSelf) {
            ...
            if (toState) {
              ...
              // place its view-locals on the __inactives pseudostate's .locals.  This allows the ui-view directives
